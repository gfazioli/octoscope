...
func (m Model) View() string {
	...
	default:
		...
		case TabInbox:
			b.WriteString(m.inbox.renderInboxTab(
				m.inboxAvailable(), m.client.PublicOnly(), available, tabHeight))
		case TabActivity:
...
// global hotkeys (1-8, p, comma, ?, q, tab) don't fire — the footer must
